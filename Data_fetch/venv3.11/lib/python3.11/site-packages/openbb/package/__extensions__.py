...
Extensions:
    ...
    @property
    def etf(self):
        """Exchange Traded Funds market data."""
        from . import etf
    ...
    @property
    def imf_utils(self):
        """Utilities for IMF provider."""
        from . import imf_utils

        return imf_utils.ROUTER_imf_utils(command_runner=self._command_runner)
    ...
    @property
    def regulators(self):
        """Financial market regulators data."""
    ...
    @property
    def uscongress(self):
        """Data connector to Congress.gov API."""
