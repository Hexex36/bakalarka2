"""Autogenerated OpenBB /equity/compare Module."""
        ...
        fact: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    "'DeferredRevenue', 'DeferredTaxAssetsGross',"
                    ...
                    "'DerivativeFairValueOfDerivativeNet', 'DerivativeL"
                    "iabilityCollateralRightToReclaimCashOffset',"
                    "'DerivativeNotionalAmount', 'DistributedEarnings',"
                    "'Dividends', 'DividendsCash',"
                    "'DividendsPayableAmountPerShare',"
                    "'DividendsPayableCurrent',"
                    "'EarningsPerShareBasic',"
                    "'EarningsPerShareDiluted', 'EffectOfExchangeRateOn"
                    'CashCashEquivalentsRestrictedCashAndRestrictedCash'
                    "Equivalents', 'EffectOfExchangeRateOnCashCashEquiv"
                    'alentsRestrictedCashAndRestrictedCashEquivalentsIn'
                    "cludingDisposalGroupAndDiscontinuedOperations',"
                    "'EmployeeRelatedLiabilitiesCurrent',"
                    "'EmployeeRelatedLiabilitiesCurrentAndNoncurrent', "
                    "'EmployeeServiceShareBasedCompensationTaxBenefitFr"
                    "omCompensationExpense',"
                    ...
                    "'FinanceLeaseLiabilityPaymentsDueYearTwo', 'Financ"
                    "eLeaseLiabilityPaymentsRemainderOfFiscalYear',"
                    ...
                    "'GeneralAndAdministrativeExpense', 'Goodwill',"
                    "'GrossProfit',"
                    "'ImpairmentOfIntangibleAssetsExcludingGoodwill', '"
                    'ImpairmentOfIntangibleAssetsIndefinitelivedExcludi'
                    "ngGoodwill', 'IncomeLossFromContinuingOperations',"
                    "'IncomeLossFromContinuingOperationsAttributableToN"
                    "oncontrollingEntity', 'IncomeLossFromContinuingOpe"
                    'rationsBeforeIncomeTaxesExtraordinaryItemsNoncontr'
                    "ollingInterest',"
                    ...
                    "'IncreaseDecreaseInOtherNoncurrentLiabilities',"
                    "'IncreaseDecreaseInPensionPlanObligations', 'Incre"
                    'mentalCommonSharesAttributableToShareBasedPaymentA'
                    "rrangements', 'InterestAndDebtExpense',"
                    "'InterestExpenseDebt', 'InterestIncomeExpenseNet',"
                    "'InterestPaid', 'InterestPaidNet', 'InventoryNet',"
                    "'InvestmentIncomeInterest', 'Land',"
                    "'LeaseAndRentalExpense',"
                    "'LesseeOperatingLeaseLiabilityPaymentsDue', 'Lesse"
                    "eOperatingLeaseLiabilityPaymentsDueAfterYearFive',"
                    "'LesseeOperatingLeaseLiabilityPaymentsDueNextTwelv"
                    "eMonths', 'LesseeOperatingLeaseLiabilityPaymentsDu"
                    "eYearFive', 'LesseeOperatingLeaseLiabilityPayments"
                    "DueYearFour', 'LesseeOperatingLeaseLiabilityPaymen"
                    "tsDueYearThree',"
                    "'LesseeOperatingLeaseLiabilityPaymentsDueYearTwo',"
                    "'LesseeOperatingLeaseLiabilityPaymentsRemainderOfF"
                    "iscalYear', 'LettersOfCreditOutstandingAmount',"
                    "'Liabilities', 'LiabilitiesAndStockholdersEquity',"
                    "'LiabilitiesCurrent', 'LineOfCredit',"
                    "'LineOfCreditFacilityMaximumBorrowingCapacity',"
                    "'LongTermDebt', 'LongTermDebtCurrent', 'LongTermDe"
                    "btMaturitiesRepaymentsOfPrincipalAfterYearFive', '"
                    'LongTermDebtMaturitiesRepaymentsOfPrincipalInNextT'
                    "welveMonths', 'LongTermDebtMaturitiesRepaymentsOfP"
                    "rincipalInYearFive', 'LongTermDebtMaturitiesRepaym"
                    "entsOfPrincipalInYearFour', 'LongTermDebtMaturitie"
                    "sRepaymentsOfPrincipalInYearThree', 'LongTermDebtM"
                    "aturitiesRepaymentsOfPrincipalInYearTwo', 'LongTer"
                    'mDebtMaturitiesRepaymentsOfPrincipalRemainderOfFis'
                    "calYear', 'LongTermDebtNoncurrent',"
                    "'LongTermInvestments',"
                    ...
                    "'NetIncomeLoss', 'NetIncomeLossAttributableToNonco"
                    "ntrollingInterest', 'NetIncomeLossAttributableToNo"
                    "nredeemableNoncontrollingInterest', 'NetIncomeLoss"
                    "AttributableToRedeemableNoncontrollingInterest',"
                    "'NoncurrentAssets', 'NoncurrentAssets',"
                    "'NoninterestIncome', 'NonoperatingIncomeExpense',"
                    "'NotesReceivableNet', 'OperatingExpenses',"
                    "'OperatingIncomeLoss', 'OperatingLeaseCost',"
                    "'OperatingLeaseLiability',"
                    "'OperatingLeaseLiabilityCurrent',"
                    "'OperatingLeaseLiabilityNoncurrent',"
                    "'OperatingLeaseRightOfUseAsset',"
                    "'OtherAccruedLiabilitiesCurrent',"
                    "'OtherAssetsCurrent', 'OtherAssetsNoncurrent', 'Ot"
                    'herComprehensiveIncomeLossAvailableForSaleSecuriti'
                    "esAdjustmentNetOfTax', 'OtherComprehensiveIncomeLo"
                    'ssCashFlowHedgeGainLossAfterReclassificationAndTax'
                    "', 'OtherComprehensiveIncomeLossDerivativeInstrume"
                    "ntGainLossafterReclassificationandTax', 'OtherComp"
                    'rehensiveIncomeLossDerivativeInstrumentGainLossbef'
                    "oreReclassificationafterTax', 'OtherComprehensiveI"
                    'ncomeLossForeignCurrencyTransactionAndTranslationA'
                    "djustmentNetOfTax',"
                    "'OtherComprehensiveIncomeLossNetOfTax', 'OtherComp"
                    'rehensiveIncomeLossNetOfTaxPortionAttributableToPa'
                    "rent', 'OtherComprehensiveIncomeUnrealizedHoldingG"
                    "ainLossOnSecuritiesArisingDuringPeriodNetOfTax',"
                    "'OtherIncome', 'OtherLiabilitiesCurrent',"
                    "'OtherLiabilitiesNoncurrent', 'OtherLongTermDebt',"
                    "'OtherNoncashIncomeExpense',"
                    "'PaymentsForCapitalImprovements', 'PaymentsForProc"
                    "eedsFromBusinessesAndInterestInAffiliates',"
                    ...
                    "'ProceedsFromIssuanceOrSaleOfEquity', 'ProceedsFro"
                    'mMaturitiesPrepaymentsAndCallsOfAvailableForSaleSe'
                    "curities',"
                    "'ProceedsFromPaymentsForOtherFinancingActivities',"
                    "'ProceedsFromPaymentsToMinorityShareholders',"
                    "'ProceedsFromRepaymentsOfShortTermDebt', 'Proceeds"
                    'FromRepaymentsOfShortTermDebtMaturingInThreeMonths'
                    "OrLess',"
                    "'ProceedsFromSaleOfPropertyPlantAndEquipment',"
                    "'ProceedsFromStockOptionsExercised', 'ProfitLoss',"
                    "'PropertyPlantAndEquipmentGross',"
                    "'PropertyPlantAndEquipmentNet',"
                    "'ReceivablesNetCurrent', 'RedeemableNoncontrolling"
                    "InterestEquityCarryingAmount',"
                    "'RepaymentsOfDebtMaturingInMoreThanThreeMonths',"
                    "'RepaymentsOfLongTermDebt',"
                    "'ResearchAndDevelopmentExpense', 'RestrictedCash',"
                    "'RestrictedCashAndCashEquivalents',"
                    "'RestrictedStockExpense', 'RestructuringCharges',"
                    "'RetainedEarningsAccumulatedDeficit', 'RevenueFrom"
                    "ContractWithCustomerExcludingAssessedTax',"
                    "'Revenues', 'SecuredLongTermDebt',"
                    "'SellingAndMarketingExpense',"
                    "'SellingGeneralAndAdministrativeExpense',"
                    "'ShareBasedCompensation', 'ShortTermBorrowings',"
                    ...
                    "'StockRepurchasedDuringPeriodValue',"
                    "'StockholdersEquity', 'StockholdersEquityIncluding"
                    "PortionAttributableToNoncontrollingInterest',"
                    "'StockholdersEquityOther', 'TaxesPayableCurrent',"
                    "'TradingSecuritiesDebt',"
                    "'TreasuryStockAcquiredAverageCostPerShare',"
                    "'TreasuryStockSharesAcquired',"
                    "'UnrealizedGainLossOnInvestments',"
                    "'UnrecognizedTaxBenefits', 'UnsecuredDebt',"
                    "'VariableLeaseCost', 'WeightedAverageNumberDiluted"
                    "SharesOutstandingAdjustment',"
...
fiscal_period : str
    ...
    Choices for sec: 'fy', 'q1', 'q2', 'q3', 'q4'
instantaneous : bool
...
symbol : str
    Symbol representing the entity requested in the data.
name : str | None
    The name of the company. (provider: fmp)
price : float | None
    The current stock price of the company. (provider: fmp)
market_cap : int | None
    The market capitalization of the company. (provider: fmp)
