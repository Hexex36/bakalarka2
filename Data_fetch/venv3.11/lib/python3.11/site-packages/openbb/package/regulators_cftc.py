"""Autogenerated OpenBB /regulators/cftc Module."""
...
class ROUTER_regulators_cftc(Container):
    ...
    def cot(
        ...
        id: Annotated[
            ...
            OpenBBField(
                description=(
                    'A string with the CFTC market code or other'
                    'identifying string, such as the contract market'
                    'name, commodity name, or commodity group - i.e,'
                    "'gold' or 'japanese yen'.Default report is Fed"
                    "Funds Futures. Use the 'cftc_market_code' for an"
                    'exact match.'
                )
            )
        ] = '045601',
...
report_type : str
    ...
    Choices for cftc: 'legacy', 'disaggregated', 'financial', 'supplemental'
futures_only : bool
