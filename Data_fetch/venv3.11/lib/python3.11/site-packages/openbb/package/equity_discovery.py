"""Autogenerated OpenBB /equity/discovery Module."""
...
volume : int | float | None
    The trading volume.
exchange : str | None
    Stock exchange where the security is listed. (provider: fmp);
...
>>> obb.equity.discovery.aggressive_small_caps(sort='desc')
    ...
    def filings(
        ...
        form_type: Annotated[
            ...
            OpenBBField(
                description=(
                    'Filter by form type. Visit'
                    'https://www.sec.gov/forms for a list of supported'
                    'form types.'
                )
            )
        ] = None,
        limit: Annotated[
            Union[Annotated[int, Ge(ge=0)], None, int] | None,
            OpenBBField(
                description=(
                    'The number of data entries to return.;     The'
                    'maximum number of results to return. Default is'
                    '10000. (provider: fmp)'
                )
            )
        ] = None,
...
limit : Annotated[int, Ge(ge=0)] | int | None
...
final_link : str | None
    Direct URL to the main document of the filing. (provider: fmp)
...
report_type : str | None
    ...
    Choices for sec: '1-K', '1-SA', '1-U', '10-D', '10-K', '10-KT', '10-Q', '10-QT', '20-F', '40-F' '6-K', '8-K'
...
index_headers : str | None
    URL to the index headers file. (provider: sec)
complete_submission : str | None
