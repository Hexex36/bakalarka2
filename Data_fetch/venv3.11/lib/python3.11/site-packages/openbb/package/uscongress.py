"""Autogenerated OpenBB /uscongress Module."""
...
from openbb_core.app.provider_interface import (
    OBBject_CongressBillInfo,
    OBBject_CongressBillText,
    OBBject_CongressBills,
)
    ...
    Raw JSON data from the collected bill information. (provider: congress_gov)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'bill_url': {'congress_gov': {'x-widget_config': {'label': 'Bill URL', 'description': "Enter a base URL of a bill (e.g., 'https://api.congress.gov/v3/bill/119/s/1947?'). Alternatively, you can enter a bill number (e.g., '119/s/1947'). Create a group on the 'Bill URL' field of the 'Congressional Bills' widget and click on the cell to view summary and metadata.", 'value': '119/hr/1'}}}},
            )
        )
...
provider : str
    The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: congress_gov.
urls : str | list[str] | dict[str, list[str]] | None
    ...
    Data format information, including data type and filename. (provider: congress_gov)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'urls': {'congress_gov': {'multiple_items_allowed': True, 'choices': None}}},
...
limit : int | None
    The number of data entries to return. When None, default sets to 100 (max 250). Set to 0 for no limit (must be used with 'bill_type' and 'congress'). Setting to 0 will nullify the start_date, end_date, and offset parameters. (provider: congress_gov)
offset : int | None
...
sort_by : str
    ...
    Choices for congress_gov: 'asc', 'desc'
...
update_date_including_text : datetime | None
    The date and time the bill text was last updated. (provider: congress_gov)
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'congress': {'congress_gov': {'x-widget_config': {'type': 'number'}}}, 'bill_type': {'congress_gov': {'x-widget_config': {'options': [{'label': 'House Bill', 'value': 'hr'}, {'label': 'Senate Bill', 'value': 's'}, {'label': 'House Joint Resolution', 'value': 'hjres'}, {'label': 'Senate Joint Resolution', 'value': 'sjres'}, {'label': 'House Concurrent Resolution', 'value': 'hconres'}, {'label': 'Senate Concurrent Resolution', 'value': 'sconres'}, {'label': 'House Simple Resolution', 'value': 'hres'}, {'label': 'Senate Simple Resolution', 'value': 'sres'}], 'value': None, 'style': {'popupWidth': 300}, 'paramName': 'bill_type', 'label': 'Bill Type'}}}, 'offset': {'congress_gov': {'x-widget_config': {'type': 'number'}}}},
            )
        )
