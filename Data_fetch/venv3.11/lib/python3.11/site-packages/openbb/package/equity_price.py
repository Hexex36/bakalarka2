...
timestamp_lt : datetime | str | None
...
timestamp_gt : datetime | str | None
...
timestamp_lte : datetime | str | None
...
timestamp_gte : datetime | str | None
...
conditions : str | list[int] | list[str] | None
...
>>> obb.equity.price.performance(symbol='AAPL')
    ...
    def quote(
        ...
        symbol: Annotated[
            ...
            OpenBBField(
                description=(
                    ...
                    'intrinio, yfinance.;     A Security identifier'
                    '(Ticker, FIGI, ISIN, CUSIP, Intrinio ID).'
                    '(provider: intrinio)'
                )
            )
        ...
        provider: Annotated[
            Optional[Literal['cboe', 'fmp', 'intrinio', 'yfinance']],
            OpenBBField(
                description=(
                    'The provider to use, by default None. If None, the'
                    'priority list configured in the settings is used.'
                    'Default priority: cboe, fmp, intrinio, yfinance.'
                )
            )
        ] = None,
        **kwargs
...
----------
provider : str
    The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: cboe, fmp, intrinio, yfinance.
symbol : str | list[str]
    Symbol to get data for. Multiple comma separated items allowed for provider(s): cboe, fmp, intrinio, yfinance.
...
>>> obb.equity.price.quote(symbol='AAPL')
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'cboe': {'multiple_items_allowed': True, 'choices': None}, 'fmp': {'multiple_items_allowed': True, 'choices': None}, 'intrinio': {'multiple_items_allowed': True, 'choices': None}, 'yfinance': {'multiple_items_allowed': True, 'choices': None}}},
            )
        )
