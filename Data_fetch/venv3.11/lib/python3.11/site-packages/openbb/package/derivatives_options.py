...
----------
provider : str
    The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: cboe, intrinio, yfinance.
symbol : str
...
delay : str
    ...
    Choices for intrinio: 'eod', 'realtime', 'delayed'
date : date | None
...
moneyness : str
    ...
    Choices for intrinio: 'otm', 'itm', 'all'
strike_gt : int | None
...
model : str
    ...
    Choices for intrinio: 'black_scholes', 'bjerk'
...
trade_type : str
    ...
    Choices for intrinio: 'block', 'sweep', 'large'
sentiment : str
    The sentiment type to query for. (provider: intrinio)
    Choices for intrinio: 'bullish', 'bearish', 'neutral'
...
source : str
    ...
    Choices for intrinio: 'delayed', 'realtime'
...
bid_at_execution : float | None
    Bid price at execution. (provider: intrinio)
ask_at_execution : float | None
