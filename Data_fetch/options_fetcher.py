#!/usr/bin/env python3
"""
Options Data Fetcher for S&P 500 Stocks
...
def fetch_american_options():
    ...
    if all_american_data:
        ...
        final_american_data = final_american_data.sort_values(['Ticker', 'Expiration', 'strike', 'Type'])
...
def fetch_european_options():
    ...
    if all_european_data:
        ...
        desired_cols = ['Ticker', 'Expiration', 'Strike', 'Type', 'Bid', 'Ask', 'Last', 'Volume', 'OpenInterest', 'ExerciseStyle']
